package com.hp.ali.stockmonk.ui.mission_monk;
...
import com.hp.ali.stockmonk.ui.knowledge_base.Knowledge_base;
...
public class MissionMonkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_mission_monk, container, false);
        ...
        Knowledgebase_ref =  FirebaseDatabase.getInstance().getReference().child("missionMonk");
    ...
    public  class Knowledge_Adapter extends RecyclerView.Adapter<Knowledge_Adapter.ViewHolder>{
        ...
        public void onBindViewHolder(Knowledge_Adapter.ViewHolder holder, int position) {
            ...
            like_ref.child(userUID).child("missionMonk").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            fav_ref.child(userUID).child("missionMonk").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                @SuppressLint("UseCompatLoadingForDrawables")
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.exists()){
            ...
            holder.linear_lyt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("ref","missionMonk");
                    ...
                    like_ref.child(userUID).child("missionMonk").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(!snapshot.exists()){
                                ...
                                like_ref.child(userUID).child("missionMonk").child(key).setValue(hashMap);
                                holder.img_like.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_like_blue));
                    ...
                    fav_ref.child(userUID).child("missionMonk").child(key).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(!snapshot.exists()){
                                ...
                                fav_ref.child(userUID).child("missionMonk").child(key).setValue(hashMap);
                                holder.img_fav.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_fav_red));
